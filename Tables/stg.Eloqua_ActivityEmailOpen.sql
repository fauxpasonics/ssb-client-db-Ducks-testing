...
[ETL_CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__Eloqua_Ac__ETL_C__22951AFD] DEFAULT (getdate()),
[ID] [bigint] NOT NULL,
...
GO
ALTER TABLE [stg].[Eloqua_ActivityEmailOpen] ADD CONSTRAINT [PK__Eloqua_A__3214EC27971FE191] PRIMARY KEY CLUSTERED  ([ID])
GO
