...
[ETL_CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__Eloqua_Co__ETL_C__5BCD9859] DEFAULT (getdate()),
[ID] [int] NOT NULL,
...
GO
ALTER TABLE [stg].[Eloqua_Contact] ADD CONSTRAINT [PK__Eloqua_C__3214EC270A86A375] PRIMARY KEY CLUSTERED  ([ID])
GO
