...
[ETL_CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__LiveAnaly__ETL_C__49309088] DEFAULT (getdate()),
[ETL_UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__LiveAnaly__ETL_U__4A24B4C1] DEFAULT (getdate()),
[ETL_IsDeleted] [bit] NULL CONSTRAINT [DF__LiveAnaly__ETL_I__4B18D8FA] DEFAULT ((0)),
...
GO
ALTER TABLE [ods].[LiveAnalytics_Customer] ADD CONSTRAINT [PK__LiveAnal__7EF6BFCDBB27128A] PRIMARY KEY CLUSTERED  ([ETL_ID])
GO
