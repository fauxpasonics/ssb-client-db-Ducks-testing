CREATE TABLE [segmentation].[SegmentationFlatDatafabfc2f0-b32f-40a0-a71e-d09fbcae0879]
(
...
GO
ALTER TABLE [segmentation].[SegmentationFlatDatafabfc2f0-b32f-40a0-a71e-d09fbcae0879] ADD CONSTRAINT [pk_SegmentationFlatDatafabfc2f0-b32f-40a0-a71e-d09fbcae0879] PRIMARY KEY NONCLUSTERED  ([id])
GO
