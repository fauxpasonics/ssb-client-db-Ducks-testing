CREATE TABLE [segmentation].[SegmentationFlatData207949e6-43e9-4a8a-8a3c-ed35c170fc50]
(
...
[Birth_Day] [int] NULL,
[Age] [int] NULL,
[Distance_From_HondaCenter] [float] NULL,
[SSB_Primary_Record_Flag] [varchar] (50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL
)
GO
ALTER TABLE [segmentation].[SegmentationFlatData207949e6-43e9-4a8a-8a3c-ed35c170fc50] ADD CONSTRAINT [pk_SegmentationFlatData207949e6-43e9-4a8a-8a3c-ed35c170fc50] PRIMARY KEY NONCLUSTERED  ([id])
GO
CREATE CLUSTERED INDEX [cix_SegmentationFlatData207949e6-43e9-4a8a-8a3c-ed35c170fc50] ON [segmentation].[SegmentationFlatData207949e6-43e9-4a8a-8a3c-ed35c170fc50] ([_rn])
GO
