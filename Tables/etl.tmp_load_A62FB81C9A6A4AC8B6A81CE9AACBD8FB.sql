CREATE TABLE [etl].[tmp_load_A62FB81C9A6A4AC8B6A81CE9AACBD8FB]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_A62FB81C9A6A4AC8B6A81CE9AACBD8FB_ss] ON [etl].[tmp_load_A62FB81C9A6A4AC8B6A81CE9AACBD8FB] ([SourceSystem], [SSID])
GO
