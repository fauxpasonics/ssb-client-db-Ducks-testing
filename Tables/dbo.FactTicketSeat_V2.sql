...
[ETL__CreatedDate] [datetime] NULL CONSTRAINT [DF_FactTicketSeat_V2__ETL__CreatedDate] DEFAULT (getutcdate())
)
GO
CREATE NONCLUSTERED INDEX [NCI_dbo_FactTicketSeat_V2__CustomerId] ON [dbo].[FactTicketSeat_V2] ([CustomerId])
GO
CREATE NONCLUSTERED INDEX [NCI_dbo_FactTicketSeat_v2__DimSeatId] ON [dbo].[FactTicketSeat_V2] ([DimSeatId])
GO
CREATE NONCLUSTERED INDEX [NCI_dbo_FactTicketSeat_v2__FactInventoryId] ON [dbo].[FactTicketSeat_V2] ([FactInventoryId])
GO
CREATE NONCLUSTERED INDEX [NCI_dbo_FactTicketSeat_V2__ResoldCustomerId] ON [dbo].[FactTicketSeat_V2] ([ResoldCustomerId])
GO
CREATE NONCLUSTERED INDEX [NCI_dbo_FactTicketSeat_v2__TicketingAccountId] ON [dbo].[FactTicketSeat_V2] ([TicketingAccountId])
GO
