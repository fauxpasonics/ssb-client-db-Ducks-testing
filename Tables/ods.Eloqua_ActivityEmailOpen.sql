...
[ETL_CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__Eloqua_Ac__ETL_C__63A3C44B] DEFAULT (getdate()),
[ETL_UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__Eloqua_Ac__ETL_U__6497E884] DEFAULT (getdate()),
[ETL_IsDeleted] [bit] NOT NULL CONSTRAINT [DF__Eloqua_Ac__ETL_I__658C0CBD] DEFAULT ((0)),
...
GO
ALTER TABLE [ods].[Eloqua_ActivityEmailOpen] ADD CONSTRAINT [PK__Eloqua_A__3214EC27F630C974] PRIMARY KEY CLUSTERED  ([ID])
GO
CREATE NONCLUSTERED INDEX [idx_EloquaEmailOpen_createdAt] ON [ods].[Eloqua_ActivityEmailOpen] ([CreatedAt])
GO
