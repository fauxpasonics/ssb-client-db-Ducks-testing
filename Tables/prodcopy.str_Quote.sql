...
[str_clientplayoffoption] [int] NULL,
[str_clientplayoffoptionname] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[str_clientplayoffround] [int] NULL,
[str_clientplayoffroundname] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[str_clientplayoffs] [nvarchar] (100) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__str_Quote__copyl__01EAB64E] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopy].[str_Quote] ADD CONSTRAINT [PK__str_Quot__965E13A6FF098F2C] PRIMARY KEY CLUSTERED  ([str_quoteid])
GO
