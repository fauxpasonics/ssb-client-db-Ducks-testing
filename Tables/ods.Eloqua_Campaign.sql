...
[ETL_CreatedDate] [datetime] NOT NULL CONSTRAINT [DF__Eloqua_Ca__ETL_C__0504B816] DEFAULT (getdate()),
[ETL_UpdatedDate] [datetime] NOT NULL CONSTRAINT [DF__Eloqua_Ca__ETL_U__05F8DC4F] DEFAULT (getdate()),
[ETL_IsDeleted] [bit] NOT NULL CONSTRAINT [DF__Eloqua_Ca__ETL_I__06ED0088] DEFAULT ((0)),
...
GO
ALTER TABLE [ods].[Eloqua_Campaign] ADD CONSTRAINT [PK__Eloqua_C__3214EC275C8501A7] PRIMARY KEY CLUSTERED  ([ID])
GO
