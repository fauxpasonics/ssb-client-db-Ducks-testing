CREATE TABLE [segmentation].[SegmentationFlatDataca9297d5-1ace-426c-a2d5-22781e5377eb]
(
...
GO
ALTER TABLE [segmentation].[SegmentationFlatDataca9297d5-1ace-426c-a2d5-22781e5377eb] ADD CONSTRAINT [pk_SegmentationFlatDataca9297d5-1ace-426c-a2d5-22781e5377eb] PRIMARY KEY NONCLUSTERED  ([id])
GO
CREATE CLUSTERED INDEX [cix_SegmentationFlatDataca9297d5-1ace-426c-a2d5-22781e5377eb] ON [segmentation].[SegmentationFlatDataca9297d5-1ace-426c-a2d5-22781e5377eb] ([_rn])
GO
