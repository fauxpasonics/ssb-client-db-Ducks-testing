...
[CreatedDate] [datetime] NULL CONSTRAINT [DF__DimEmailS__Creat__2F73208A] DEFAULT (getdate()),
[CreatedBy] [varchar] (100) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[UpdatedDate] [datetime] NULL CONSTRAINT [DF__DimEmailS__Updat__306744C3] DEFAULT (getdate()),
