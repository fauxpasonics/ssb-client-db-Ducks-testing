...
CREATE PROCEDURE [api].[Registry_View]
...
DECLARE @SSB_CRMSYSTEM_CONTACT_ID VARCHAR(50) = 'ADE0184C-028C-4C65-8905-614F64040BC4'
...
, ISNULL(AddressPrimaryStreet,'')+ '' + ISNULL(AddressPrimarySuite,'')+ ', ' +ISNULL(AddressPrimaryCity,'')
+ ', ' +ISNULL(AddressPrimaryState,'')+ ' ' +ISNULL(AddressPrimaryZip,'')	Address_Primary
