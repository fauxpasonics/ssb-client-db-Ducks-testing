...
SELECT ssbid.SSB_CRMSYSTEM_CONTACT_ID
	...
	, pc.donotsendmm
	, pc.owneridname
	, pc.str_lastactivitydate
	, pc.str_openactivitycount
	, pc.str_openticketopportunity
	, pc.str_oppdaysinstage
	, pc.str_oppproduct
	, pc.str_oppsource
	, pc.str_oppstage
	, str_source
FROM Ducks_Reporting.prodcopy.Contact pc
