...
--base set
		...
		WHERE 1=1
		--AND ca.acct_id = '4744867'
		--and isnull(c.name_first,'') = '' AND isnull(c.company_name,'') = '' AND c.name_last <> '' AND c.name_last IS NOT NULL 
	   AND (c.UpdateDate > DATEADD(DAY,-3,GETDATE()) OR add_date > DATEADD(DAY,-3,GETDATE()))
	--and c.acct_id = '18567782'
