...
/*Standard Attributes*/
      , CAST(sdu.UserID AS NVARCHAR(100)) AS [SSID]
...
/*Source Created and Updated*/
      ...
      , NULL [SSUpdatedDate]
      ,NULL AS accountid -- sdu2.TicketAccountID [AccountId]
      , NULL IsBusiness
	  , 0 AS IsDeleted
	  , CASE WHEN sdu.ticketaccountID <>'' AND sdu.ticketaccountID <> '0' THEN CONCAT('TM-', sdu.TicketAccountID) ELSE NULL END AS Customer_MatchKey
